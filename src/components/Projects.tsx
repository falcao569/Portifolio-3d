...
export function Projects() {
  ...
  return (
    <section id="projects" className="relative py-32 px-6 overflow-hidden">
      {/* Background effects */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#0C1020] via-[#1E3A8A]/10 to-[#0C1020]" />
        ...
        <div className="relative h-[600px] flex items-center justify-center" ref={constraintsRef}>
          <div className="relative w-full max-w-5xl h-full flex items-center justify-center">
            {getVisibleProjects().map((project) => {
              ...
              return (
                ...
                >
                  <div
                    className="w-[500px] h-[350px] rounded-3xl overflow-hidden border border-white/10"
                    style={{
                  ...
                  >
                    ...
                    <div className="relative h-2/3 overflow-hidden">
                      ...
                      {/* Category badge */}
                      <div className="absolute top-4 right-4 px-4 py-2 rounded-full bg-white/10 backdrop-blur-xl border border-white/20">
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex gap-4 z-20">
            <Button
              variant="outline"
              size="icon"
              className="w-12 h-12 rounded-full bg-white/5 backdrop-blur-xl border-white/10 hover:bg-white/10 hover:border-[#38BDF8]/50"
              onClick={prevProject}
            >
        ...
        {selectedProject && (
          ...
          >
            ...
            >
              {/* Close button */}
              <button
                className="absolute top-6 right-6 z-10 w-10 h-10 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/20 flex items-center justify-center transition-colors"
                onClick={() => setSelectedProject(null)}
              >
              ...
              <div className="p-8">
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                    <div className="text-3xl text-[#38BDF8] mb-2">
                  ...
                  <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                    ...
                    <div className="text-sm text-gray-400">Carregamento</div>
                  </div>
                </div>

                {/* Technologies */}
                <div className="mb-8">
                  <h4 className="text-xl text-white mb-4">Tecnologias</h4>
